...
au jeu en marchant sur le plateau, mais interagit avec tous les joueurs de différentes manières.
    ...
    lui ou laissez passer. Si l'investissement provient déjà d'un autre joueur, qui tombe dans la boîte, vous devez lui payer une somme d'argent basée sur la valeur de l'investissement\an{pas compris cette phrase}.
    ...
    à nouveau disponible\an{ca veut dire quoi qu'il reste a nouveau dispo}.
    ...
    traiter, ces valeurs changent (impôt sur le revenu, impôt foncier personnel, etc.)\an{pas compris la dernière phrase}
...
montant à payer par le joueur lorsqu'il tombe dans la boîte\an{c'est quoi la boite} et décide d'assumer ledit
investissement.
Chaque investissement génère un revenu calculé en pourcentage du prix de
référence, qui est facturé au joueur qui tombe dans la boîte\an{pas compris}. Prix et pourcentages de
...
\subsection{Simulation}
 ...
 parmi façon de voir les différentes variantes\an{pas compris cette derniere partie de phrase} :
 \begin{itemize}
